...
namespace ReactASPCrud.Services
{
    public class UserService
    {
        ...
        private static readonly string[] names = new string[] { "Antonio", "Angel", "Lorem", "Lorem", "Lorem", "Lorem", "Lorem", "Lorem" };
        private static readonly string[] surnames = new string[] { "Villasenor", "Jordanovski", "Ipsum", "Ipsum", "Ipsum", "Ipsum", "Ipsum", "Ipsum" };
